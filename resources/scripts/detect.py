...
if __name__ == '__main__':
    ...
    out = '_analyzed.jpg'
    image_name = args[0].split('/')
    # Getting the List Lenght
    list_size = len(image_name) 
    name_image = image_name[list_size-1].split('.')[0]
    home_dir = os.getenv("HOME")
	
    im.save(home_dir + "/.mca/analysis/" + name_image + out)
